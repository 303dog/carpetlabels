      ...
      return (
          <div classsName="request__container">
            <div className='request__container'>
                ...
                <form>
                <h5>First Name</h5>
                <input type="text" id='fName' className='text' value={this.state.fName} onChange={this.handleChange} />
                ...
                <input type="tel" id='phone' value={this.state.p_number} placeholder="123-45-678" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" required onChange={this.handleChange} />
